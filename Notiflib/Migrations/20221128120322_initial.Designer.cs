...
namespace Notiflib.Migrations
{
    ...
    [Migration("20221128120322_initial")]
            ...
            modelBuilder.Entity("Notiflib.Participant", b =>
                {
                    ...
                    b.Property<int>("user_parti_fk")
                        .HasColumnType("integer");

                    b.HasKey("event_id", "user_id");

                    b.HasIndex("event_parti_fk");

                    b.HasIndex("user_parti_fk");
            ...
            modelBuilder.Entity("Notiflib.UserResourse", b =>
                {
                    ...
                    b.Property<int>("res_res_fk")
                        .HasColumnType("integer");

                    b.Property<int>("user_res_fk")
                        .HasColumnType("integer");

                    b.HasKey("user_id", "resourse_id");

                    b.HasIndex("res_res_fk");

                    b.HasIndex("user_res_fk");
            ...
            modelBuilder.Entity("Notiflib.Notification", b =>
                {
                    b.HasOne("Notiflib.Participant", "participant")
                        ...
                        .HasForeignKey("event_id", "user_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Notiflib.Participant", b =>
                {
                    b.HasOne("Notiflib.Event", "ewent")
                        ...
                        .HasForeignKey("event_parti_fk")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Notiflib.User", "user")
                        .WithMany("eventPart")
                        .HasForeignKey("user_parti_fk")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
